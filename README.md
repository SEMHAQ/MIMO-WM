...
| Model | MSE (×10⁻²) | R² | Params (M) |
|-------|-------------|-----|------------|
| LSTM-WM | 60.42±0.18 | 0.368 | 0.227 |
| GRU-WM | 58.84±0.07 | 0.384 | 0.190 |
| Transformer-WM | 53.18±0.13 | 0.444 | 0.302 |
| Mamba-WM | 59.25±0.38 | 0.380 | 0.224 |
| TCN-WM | 55.10±0.08 | 0.424 | 0.189 |
| **MIMO-WM** | **53.10±0.07** | **0.444** | **0.138** |
| MIMO-WM (w/o gating) | 50.61±0.22 | 0.471 | 0.101 |
