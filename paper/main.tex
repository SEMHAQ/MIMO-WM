...
实验结果表明:
\begin{enumerate}
\item[1)] LSTM-WM(2层)在预测精度上表现最优(MSE=0.85$\times10^{-3}$), 但推理速度最慢(27.8ms);
...
\bibitem{22}GU A, GU A, RE C. On the parameterization and initialization of diagonal state space models. {\it Advances in Neural Information Processing Systems}, 2022, 35: 27682--27695.
