...
# D4RL Humanoid ablation data (5 seeds)
configs = ['默认', 'L=2', 'L=6', 'N=32', 'D=64', 'D=256']
mse_vals = [0.299, 0.306, 0.299, 0.298, 0.376, 0.258]
mse_errs = [0.003, 0.003, 0.001, 0.003, 0.006, 0.002]
r2_vals = [0.625, 0.618, 0.626, 0.627, 0.530, 0.676]
params = [0.23, 0.12, 0.28, 0.25, 0.09, 0.65]
