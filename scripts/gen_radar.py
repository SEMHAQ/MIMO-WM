...
raw_scores = {
    'LSTM':    [0.535,  1/0.3716,  1/2.9,  1/0.64],
    'GRU':     [0.566,  1/0.3472,  1/2.4,  1/0.50],
    'Trans.':  [0.621,  1/0.3028,  1/2.9,  1/0.15],
    'Mamba':   [0.664,  1/0.2689,  1/9.5,  1/0.66],
    'S4D-WM':  [0.664,  1/0.2689,  1/8.3,  1/0.23],
}
